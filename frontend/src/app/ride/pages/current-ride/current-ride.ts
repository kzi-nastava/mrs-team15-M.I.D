...
export class CurrentRide implements OnInit {
  ...
  // Method to get formatted start and end addresses for the current ride, uses the formatAddress utility function to convert raw address data into a human-readable format
